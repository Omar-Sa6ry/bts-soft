...
| `SMS_PROVIDER` | `string` | Optional | Default SMS provider (`twilio`, `smsmisr`, or `vonage`) | `twilio` |
...
| `VONAGE_API_KEY` | `string` | Optional | API Key for Vonage (Nexmo) | - |
| `VONAGE_API_SECRET` | `string` | Optional | API Secret for Vonage (Nexmo) | - |
| `VONAGE_SENDER` | `string` | Optional | Outbound Sender ID or phone number for Vonage | - |
